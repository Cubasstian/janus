...
<script type="text/javascript">
                ...
                fila += `<tr id=${registro.id}>
                            ...
                            <td>
                                <table>
                                    <tr>
                                        <td>
                                            <button type="button" class="btn btn-default btn-sm" onClick="mostrarDetalle(${registro.id},'tercero')" title="ver detalle">
    ...
    function aceptar(idProceso, idSolicitud){
        Swal.fire({
            icon: 'question',
            title: 'Confirmación',
            html: `Esta seguro de haber creado el tercero registrado en el proceso #${idProceso}`,
